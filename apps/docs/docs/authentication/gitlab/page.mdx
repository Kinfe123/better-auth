...
### Get your GitLab credentials
    ...
    * `provider`: The provider to use. It should be set to `gitlab`.
    ...
    ```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/gitlab.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

...
### Get your Twitter Credentials
    ...
    * `provider`: The provider to use. It should be set to `twitter`.
    ...
    ```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/twitter.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

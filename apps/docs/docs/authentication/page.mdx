...
description: "Authentication method docs discovered from existing documentation and source evidence."
order: 180
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/apple.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

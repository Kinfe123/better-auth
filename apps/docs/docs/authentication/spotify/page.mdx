...
### Get your Spotify Credentials
    ...
    * `provider`: The provider to use. It should be set to `spotify`.
    ...
    ```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/spotify.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

...
### Get your Naver Credentials
    ...
    * `provider`: The provider to use. It should be set to `naver`.
    ...
    ```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/naver.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

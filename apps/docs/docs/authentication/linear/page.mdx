...
### Get your Linear credentials
    ...
    * `admin`: Full access to admin level endpoints (use with caution)
    ...
    ```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/authentication/linear.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

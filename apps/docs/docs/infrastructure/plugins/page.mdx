---
title: "Plugins"
description: "Repository-specific plugins pages generated for Better Auth."
order: 1830
---
...
```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/infrastructure/plugins/audit-logs.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

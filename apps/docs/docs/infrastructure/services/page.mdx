---
title: "Services"
description: "Repository-specific services pages generated for Better Auth."
order: 1840
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/infrastructure/services/email.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

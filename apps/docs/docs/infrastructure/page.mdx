...
description: "Repository-specific infrastructure pages generated for Better Auth."
order: 1770
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/infrastructure/getting-started.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

---
title: "Integrations"
description: "Framework and runtime integration docs discovered from existing documentation and source evidence."
order: 1000
---
...
```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/integrations/astro.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

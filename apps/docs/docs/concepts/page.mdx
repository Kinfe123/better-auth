---
title: "Concepts"
description: "Conceptual docs discovered from existing documentation and source evidence."
order: 40
---
...
```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/concepts/api.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

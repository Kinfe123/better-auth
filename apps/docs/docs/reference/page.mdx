---
title: "Reference"
description: "Reference docs discovered from existing documentation and package metadata."
order: 1480
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/reference/contributing.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

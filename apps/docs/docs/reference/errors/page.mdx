---
title: "Errors"
description: "Repository-specific errors pages generated for Better Auth."
order: 1500
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/reference/errors/account_already_linked_to_different_user.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

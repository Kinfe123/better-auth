...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/reference/errors/oauth_provider_not_found.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

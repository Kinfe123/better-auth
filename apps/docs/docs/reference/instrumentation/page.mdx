...
* **Attributes:**
  ...
  * `db.collection.name` - The database collection/model name (e.g. `user`)
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/reference/instrumentation.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

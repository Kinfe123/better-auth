---
title: "Quickstart"
description: "Run Better Auth with the current scripts and configuration."
order: 10
---
...
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/basic-usage.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes

---
title: "Api Key"
description: "Repository-specific api key pages generated for Better Auth."
order: 610
---
...
```
## Generated Context
This page is grounded in the repository's existing documentation at `docs/content/docs/plugins/api-key/advanced.mdx`, then placed into the generated Docs Cloud sidebar for Better Auth.
## Maintainer Notes
